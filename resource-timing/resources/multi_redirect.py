def main(request, response):
    """Handler that causes multiple redirection.
    The request should typically have three query parameters:
    page_origin - The page origin, used for redirection and to set TAO.
    cross_origin - The cross origin used to make this a cross-origin redirect.
    timing_allow - Whether TAO should be set or not in the redirect chain. Default: not set.
    Note that |step| is a parameter used for the multi-redirect.
    """
    step = 1
